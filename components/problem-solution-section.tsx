      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-balance mb-4 sm:mb-6">
            <span className="text-red-400">24/7</span> Markets Punish Offline Traders
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-3xl mx-auto font-light leading-relaxed">
            BTC can drop, ETF flows can flip, and leverage can unwind while you are sleeping. NightWatch gives the
            portfolio a guardian that stays awake.
          </p>
        </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-red-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-red-400">The Overnight Risk</h3>
              </div>

              {/* Key Stat */}
              <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-red-400 mb-2">12% Dump</div>
                <p className="text-white/80 text-sm sm:text-base">
                  A single overnight move can erase weeks of profit before the trader even opens the chart
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-white/70 text-sm sm:text-base">
                    Sentiment, ETF flows, and news shocks change while traders are offline
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                    Manual stop-losses are often too late or emotionally moved
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">Liquidation cascades punish portfolios without hedges</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-green-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-green-400">NightWatch AI</h3>
              </div>

              {/* Key Stat */}
              <div className="bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-green-400 mb-2">AI Guard</div>
                <p className="text-white/80 text-sm sm:text-base">
                  A live risk engine watches SoSoValue intelligence and prepares SoDEX protection on ValueChain
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Scores portfolio danger from market, flow, and news data</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Builds signed SoDEX stop, hedge, and profit-lock intents</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Keeps the user in control with wallet-based execution</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">82</div>
            <p className="text-white/70 text-xs sm:text-sm">Critical danger trigger</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">35%</div>
            <p className="text-white/70 text-xs sm:text-sm">Safe-mode hedge budget</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">24/7</div>
            <p className="text-white/70 text-xs sm:text-sm">Market guardian</p>
          </div>
        </div>
        ...
        >
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-4 text-balance">
            Sleep Without Ignoring Risk
          </h3>
          <p className="text-sm sm:text-base md:text-lg text-white/70 mb-6 sm:mb-8 max-w-2xl mx-auto font-light leading-relaxed">
            Use the live console to connect a wallet, read SoSoValue intelligence, and prepare ValueChain protection
            orders through SoDEX.
          </p>
          <Button
            asChild
            size="lg"
